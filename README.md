...
> 📷 *(Insérer ici une capture du MCD — réalisable avec Looping ou draw.io à partir du schéma ci-dessous)*
...
> 📷 *(Insérer ici une capture du diagramme de paquetages depuis Visual Studio : Architecture → Nouveau diagramme de dépendances)*
